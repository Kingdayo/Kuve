...
const denialData = [
  { name: 'Prior Authorization', value: 35, color: '#A78BFA' },
  { name: 'Coverage Issues', value: 8, color: '#C4B5FD' },
  { name: 'Duplicate Claims', value: 12, color: '#93C5FD' },
  { name: 'Missing Documents', value: 20, color: '#6EE7B7' },
  { name: 'Coding Errors', value: 25, color: '#FDE68A' },
];
...
const renderCustomizedLabel = ({ cx, cy, midAngle, outerRadius, percent, name }) => {
  ...
  return (
    <text x={x} y={y} fill="#6B7280" textAnchor={x > cx ? 'start' : 'end'} dominantBaseline="central" style={{ fontSize: '12px' }}>
...
const DashboardOverview = () => {
  ...
  return (
    <div className="dashboard-grid">
      <div className="grid-item-1 stat-card">
        <div className="stat-card-header">
            <p className="stat-card-label">Avg Processing Time</p>
            <svg className="stat-card-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
        </div>
      ...
      <div className="grid-item-2 stat-card success">
        <div className="stat-card-header">
            <p className="stat-card-label">Avg Success Rate</p>
            <svg className="stat-card-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
        </div>
        <p className="stat-card-value">93%</p>
        <p className="stat-card-subtext">+2 percent vs last month</p>
      </div>
      <div className="grid-item-3 stat-card patterns">
        <div className="stat-card-header">
            <p className="stat-card-label">Patterns Learned</p>
            <svg className="stat-card-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 8.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 018.25 20.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25A2.25 2.25 0 0113.5 8.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25a2.25 2.25 0 01-2.25-2.25v-2.25z" /></svg>
        </div>
      ...
      <div className="grid-item-5 grid-card chart-card">
      ...
      <div className="grid-item-6 grid-card chart-card">
