...
def verify_search_icon_color(page: Page):
    """
    This script verifies the color change of the search icon on the Claims Management page.
    """
    ...
    header_element.screenshot(path="jules-scratch/verification_search_icon_color/search-icon-color-verification.png")
...
def main():
    with sync_playwright() as p:
        ...
        """)
        try:
            verify_search_icon_color(page)
            print("Verification script for search icon color change ran successfully.")
        except Exception as e:
            print(f"An error occurred: {e}")
            page.screenshot(path="jules-scratch/verification_search_icon_color/error.png")
        finally:
            browser.close()
